...
if (Test-Path "pyproject.toml") { & .\.venv\Scripts\python.exe -m pip install -e ".[dev,service]" } elseif (Test-Path "requirements.txt") { & .\.venv\Scripts\python.exe -m pip install -r requirements.txt }
